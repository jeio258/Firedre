...
INSERT INTO site_links (name, url, icon, location, kind, sort_order, enabled, updated_at) VALUES
  ('GitHub',      'https://github.com/CuteLeaf/Firefly',   'fa7-brands:github',        'navbar',  'link', 0, 1, datetime('now')),
...
-- 页脚 Powered by 外链（location=footer，沿用原 Footer.astro 硬编码 Firefly）
INSERT INTO site_links (name, url, icon, location, kind, sort_order, enabled, updated_at) VALUES
...
INSERT INTO site_links (name, url, icon, location, kind, sort_order, enabled, updated_at) VALUES
  ...
  ('GitHub','https://github.com/CuteLeaf',    'fa7-brands:github',    'profile', 'link', 1, 1, datetime('now')),
