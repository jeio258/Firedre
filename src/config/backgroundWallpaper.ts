...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	 ...
	 * 2. src 目录（不以 "/" 开头，自动优化，推荐）："assets/images/banner.avif"
	 * 3. 远程 URL："https://example.com/banner.jpg"（不优化，注意控制体积）
	 *
	 * 单张图或随机图 API 直接填字符串（如 "https://t.alcy.cc/pc"），
	 * 多张图填数组，每次刷新随机显示一张。
	 * 自定义图片请勿命名为 d1-d6 / m1-m6，以免与示例图冲突被覆盖。
	 */
	src: {
		// 桌面背景图片（支持单张或多张随机）
