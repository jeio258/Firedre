...
const SCHEMA: Record<
	string,
	{ src: () => AnyObj; fields: Record<string, Spec> }
> = {
	basic: {
		...
		fields: {
			...
			tagStyle: "tagStyle",
			hue: "themeColor.hue",
			defaultMode: "themeColor.defaultMode",
			cardBorder: "card.border",
			cardFollowTheme: "card.followTheme",
			cardRadius: "card.radius",
			keywords: { path: "keywords", join: "," },
			pageFriends: "pages.friends",
			pageGuestbook: "pages.guestbook",
			pageDynamic: "pages.dynamic",
			pageGallery: "pages.gallery",
			pageBooknav: "pages.booknav",
			pageBilibili: "pages.bilibili",
			pageBangumi: "pages.bangumi",
			pageVndb: "pages.vndb",
			pageMal: "pages.mal",
	...
	comment: {
		...
		fields: {
			...
			twikooJsUrl: "twikoo.jsUrl",
			walineServer: "waline.serverURL",
			disqusShortname: "disqus.shortname",
			artalkServer: "artalk.server",
			artalkSiteName: { const: "" },
		},
	},
	music: {
	...
	theme: {
		...
		fields: {
			...
			homeTextEnable: "common.homeText.enable",
			homeTitle: "common.homeText.title",
			homeTitleSize: "common.homeText.titleSize",
			homeSubtitles: { path: "common.homeText.subtitle", json: true },
			homeSubtitleSize: "common.homeText.subtitleSize",
			typewriter: "common.homeText.typewriter.enable",
			typewriterSpeed: "common.homeText.typewriter.speed",
			typewriterDeleteSpeed: "common.homeText.typewriter.deleteSpeed",
			typewriterPauseTime: "common.homeText.typewriter.pauseTime",
			carousel: "common.carousel.enable",
			carouselInterval: "common.carousel.interval",
			carouselTransition: "common.carousel.transitionEffect",
			overlayOpacity: "overlay.opacity",
			overlayBlur: "overlay.blur",
			overlayCardOpacity: "overlay.cardOpacity",
		},
	},
	effects: {
	...
	dynamic: {
		...
		fields: {
			...
			apiUrl: "apiUrl",
			memosEnable: "memos.enable",
			memosApiUrl: "memos.apiUrl",
		},
	},
	announcement: {
		...
		fields: {
			enabled: "enable",
			title: "title",
			sections: { path: "sections", json: true },
		},
	},
	nav: {
	...
	analytics: {
		...
		fields: {
			...
			umamiId: "umamiAnalytics.websiteId",
			umamiUrl: "umamiAnalytics.scriptUrl",
		},
	},
	plantuml: {
