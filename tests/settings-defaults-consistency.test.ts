import { backgroundWallpaper } from "@shared/config/backgroundWallpaper";
import { booknavConfig, booknavPageConfig } from "@shared/config/booknavConfig";
import { commentConfig } from "@shared/config/commentConfig";
import { coverImageConfig } from "@shared/config/coverImageConfig";
import { dynamicConfig } from "@shared/config/dynamicConfig";
import { sakuraConfig } from "@shared/config/effectsConfig";
import { expressiveCodeConfig } from "@shared/config/expressiveCodeConfig";
...
import { sidebarLayoutConfig } from "@shared/config/sidebarConfig";
import { siteConfig } from "@shared/config/siteConfig";
import { sponsorConfig } from "@shared/config/sponsorConfig";
